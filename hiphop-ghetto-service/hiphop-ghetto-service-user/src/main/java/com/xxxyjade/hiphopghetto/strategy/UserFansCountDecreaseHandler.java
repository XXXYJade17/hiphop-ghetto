...
@AllArgsConstructor
@Slf4j
public class UserFansCountDecreaseHandler implements IStrategy<StatsOperationEvent>{

    private final IUserService userService;

    @Override
    public void handle(StatsOperationEvent event) {
        userService.decreaseFansCount(event.getResourceId());
    }
    ...
    public StatsType getStatsType() {
        return StatsType.FANS_COUNT;
    }

    @Override
    public Operation getOperationType() {
        return Operation.COUNT_DECREASE;
    }
